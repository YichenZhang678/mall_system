export default {
  ...
  'pages.login.accountLogin.errorMessage':
    'Nama pengguna dan kata sandi salah(k99admin/k99user/k99comp)',
  'pages.login.failure': 'Log masuk gagal, silakan coba lagi!',
  'pages.login.success': 'Login berhasil!',
  'pages.login.username.placeholder': 'nama pengguna: k99admin atau k99user',
  'pages.login.username.required': 'Nama pengguna harus diisi!',
  'pages.login.password.placeholder': 'kata sandi: k99comp',
